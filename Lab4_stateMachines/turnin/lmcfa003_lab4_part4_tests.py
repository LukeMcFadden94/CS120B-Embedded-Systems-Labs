...
tests = [ 
    ...
    {'description': 'Test #2', 
    'steps': [ 
    {'inputs': [('PINA', 0x01), ('PINA', 0x02)], 'iterations': 2 }, ],
    'expected': [('PORTB', 0x01)],
    },
    # {'description': 'Test #2', 
    # 'steps': [ {'inputs': [('PINA', 0x01)], 'time': 100 },
    # 'expected': [('PORTB', 0x02)] ],
    # 'steps': [ {'inputs': [('PINA', 0x01)], 'time': 100}.
    # 'expected': [('PORTB', 0x01)] ],
    # },
    ...
    # #     {'inputs': [('PINA', 0x01)], 'time': 100 }, # Set PIN to val then run 300 ms
    #     {'inputs': [('PINA', 0x01)], 'iterations': 1, 
    #       'expected': [('PORTB', 0x02)]}, 
    #     # {'inputs': [('PINA',0x01)], 'time': 100}, ],
    #     #   'expected': [('PORTB',0x01)],
    # # },

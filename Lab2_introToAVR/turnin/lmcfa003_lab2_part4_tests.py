...
tests = [ 
    ...
    # 'expected': [('PORTD',0xAB)]
    # },
    {'description': 'PINA[1:0]: 40, PINB[1:0]: 40, PINC[1:0]: 40',
    'steps': [ {'inputs': [('PINA',0x40), ('PINB',0x40), ('PINC',0x40)], 'iterations': 2 } ],
    'expected': [('PORTD',0x31)]
    },
    {'description': 'PINA[1:0]: 00, PINB[1:0]: 23, PINC[1:0]: 55',
    'steps': [ {'inputs': [('PINA',0x00), ('PINB',0x23), ('PINC',0x55)], 'iterations': 2 } ],
    'expected': [('PORTD',0x1E)]
    },
    {'description': 'PINA[1:0]: 00, PINB[1:0]: 38, PINC[1:0]: 55',
    'steps': [ {'inputs': [('PINA',0x00), ('PINB',0x38), ('PINC',0x55)], 'iterations': 2 } ],
    'expected': [('PORTD',0x22)]
    },
    {'description': 'PINA[1:0]: 00, PINB[1:0]: 00, PINC[1:0]: 00',
    'steps': [ {'inputs': [('PINA',0x00), ('PINB',0x00), ('PINC',0x00)], 'iterations': 2 } ],
    'expected': [('PORTD',0x00)]
    },
    {'description': 'PINA[1:0]: 20, PINB[1:0]: 30, PINC[1:0]: 40',
    'steps': [ {'inputs': [('PINA',0x14), ('PINB',0x1E), ('PINC',0x28)], 'iterations': 2 } ],
    'expected': [('PORTD',0x58)]
    },
    {'description': 'PINA[1:0]: 64, PINB[1:0]: 32, PINC[1:0]: 00',
    'steps': [ {'inputs': [('PINA',0x64), ('PINB',0x32), ('PINC',0x00)], 'iterations': 2 } ],
    'expected': [('PORTD',0x26)]
    },
...
watch = ['main::tempA', 'main::tempB', 'main::tempC', 'main::tempD', 'main::totalWeight', 'PORTD']
